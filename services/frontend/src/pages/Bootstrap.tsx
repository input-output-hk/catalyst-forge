...
type BootstrapRequestBody = paths['/api/v1/auth/bootstrap']['post']['requestBody']['content']['application/json'];
type BeginCredentialRequestBody = paths['/api/v1/auth/credentials/add/begin']['post']['requestBody']['content']['application/json'];
type BeginCredentialResponse = paths['/api/v1/auth/credentials/add/begin']['post']['responses'][200]['content']['application/json'];
type CompleteCredentialRequestBody = paths['/api/v1/auth/credentials/add/complete']['post']['requestBody']['content']['application/json'];
    ...
    const onSubmit = async (values: z.infer<typeof schema>) => {
        ...
        try {
            ...
            try {
                ...
                if (token && (forge as unknown as { setAccessToken?: (t: string) => void }).setAccessToken) {
            ...
            try {
                ...
                const beginData = beginResponse.data as BeginCredentialResponse || {} as BeginCredentialResponse;
                ...
                const publicKeyCredential = await createCredentialFromServerPublicKey(serverResponse.publicKey);
                ...
                <CardContent>
                    <Form {...form}>
                        <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-4" noValidate>
                            ...
                            <FormField name="bootstrap_token" control={form.control} render={({ field }) => (
                                <FormItem>
                            ...
                            <FormField name="device_name" control={form.control} render={({ field }) => (
                                <FormItem>
