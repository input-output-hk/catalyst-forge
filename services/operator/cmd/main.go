...
import (
	...
	foundryv1alpha1 "github.com/input-output-hk/catalyst-forge/services/operator/api/v1alpha1"
	"github.com/input-output-hk/catalyst-forge/services/operator/internal/controller"
	"github.com/input-output-hk/catalyst-forge/services/operator/pkg/config"
	"github.com/input-output-hk/catalyst-forge/services/operator/pkg/handlers"
...
func init() {
	...
	utilruntime.Must(foundryv1alpha1.AddToScheme(scheme))
...
func main() {
	...
	mgr, err := ctrl.NewManager(ctrl.GetConfigOrDie(), ctrl.Options{
		...
		LeaderElectionID:       "c6038381.projectcatalyst.io",
