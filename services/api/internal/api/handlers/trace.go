...
import (
	...
	"github.com/input-output-hk/catalyst-forge/services/api/internal/models/trace"
...
func (h *TraceHandler) GetByID(c *gin.Context) {
	type pathParam struct {
		TraceID string `uri:"trace_id" binding:"required,uuid4"`
	}
	var p pathParam
	...
	id, err := h.ParseUUID(p.TraceID)
	if err != nil {
		h.RespondWithValidationError(c, err)
		return
	}

	tr, err := h.service.GetByID(c.Request.Context(), id)
	if err != nil {
