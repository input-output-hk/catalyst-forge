...
type CuePublisherConfig struct {
	Version string `json:"version"`
}

type CuePublisher struct {
	config        CuePublisherConfig
...
func (r *CuePublisher) Publish() error {
...
func (r *CuePublisher) loadModule() (string, error) {
...
func NewCuePublisher(ctx run.RunContext,
	project project.Project,
	name string,
	force bool,
) (*CuePublisher, error) {
