...
type KCLPublisherConfig struct {
	Container string `json:"container"`
}

type KCLPublisher struct {
	config        KCLPublisherConfig
	ecr           aws.ECRClient
	force         bool
...
func (r *KCLPublisher) Publish() error {
...
// NewKCLPublisher creates a new KCL publish provider.
func NewKCLPublisher(ctx run.RunContext,
	project project.Project,
	name string,
	force bool,
) (*KCLPublisher, error) {
