...
// Bootstrap initializes the database with authkit stores and runs migrations.
//
// Example:
//
//	cfg := db.Config{
...
//	}
//	
//	dbStore, stores, err := Bootstrap(ctx, cfg)
//	if err != nil {
//	    return err
//	}
//	defer db.Close(dbStore)
func Bootstrap(ctx context.Context, cfg repodb.Config) (repodb.Store, *Stores, error) {
