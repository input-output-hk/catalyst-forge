...
const (
	...
	// Device link events (CLI authentication)
	EventDeviceLinkBegin      EventType = "device_link.begin"
	EventDeviceLinkAuthorized EventType = "device_link.authorized"
	EventDeviceLinkExchanged  EventType = "device_link.exchanged"
	EventDeviceLinkExpired    EventType = "device_link.expired"
	EventDeviceLinkFailed     EventType = "device_link.failed"
	
	// Device management events
	EventDeviceCreated        EventType = "device.created"
	EventDeviceUsed           EventType = "device.used"
