...
import (
	...
	"github.com/input-output-hk/catalyst-forge/foundry/api/internal/models/repository"
...
func (h *RepositoryHandler) GetByID(c *gin.Context) {
	var param contracts.RepositoryIDParam
	if err := c.ShouldBindUri(&param); err != nil {
		h.RespondWithValidationError(c, err)
		return
	}

	repo, err := h.service.GetByID(c.Request.Context(), param.RepositoryID)
	if err != nil {
