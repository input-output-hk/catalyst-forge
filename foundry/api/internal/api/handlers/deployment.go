...
func (h *DeploymentHandler) GetByID(c *gin.Context) {
	...
	dep, err := h.service.GetByID(c.Request.Context(), param.DeploymentID)
	if err != nil {
...
func (h *DeploymentHandler) Update(c *gin.Context) {
	...
	dep, err := h.service.Update(c.Request.Context(), param.DeploymentID, svcReq)
	if err != nil {
		if errors.Is(err, deploymentService.ErrDeploymentNotFound) {
			h.RespondWithNotFound(c, "Deployment")
			return
...
func (h *DeploymentHandler) Delete(c *gin.Context) {
	...
	if err := h.service.Delete(c.Request.Context(), param.DeploymentID); err != nil {
		if errors.Is(err, deploymentService.ErrDeploymentNotFound) {
			h.RespondWithNotFound(c, "Deployment")
			return
		}
